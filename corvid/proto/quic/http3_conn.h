...
#pragma region Stream binding
  ...
  // Bind `stream_id` as the outgoing HTTP/3 control stream (a locally
  // initiated unidirectional stream). nghttp3 queues the stream type byte +
  // SETTINGS for the next `writev_stream`.
