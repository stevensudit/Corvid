...
inline constexpr bool has_all_components_v =
    (tuple_contains_v<Cs, typename Storage::tuple_t> && ...); // NOLINT(readability-redundant-typename)
...
inline constexpr size_t component_match_count_v =
    (static_cast<size_t>(std::is_same_v<C, typename Storages::component_t>) + // NOLINT(readability-redundant-typename)
        ...);
...
inline constexpr size_t tag_match_count_v =
    (static_cast<size_t>(std::is_same_v<C, typename Storages::tag_t>) + ...); // NOLINT(readability-redundant-typename)
