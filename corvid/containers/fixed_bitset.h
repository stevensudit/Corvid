...
public:
  ...
  [[nodiscard]] constexpr bool empty() noexcept { return bit_count_v == 0; }
  [[nodiscard]] constexpr size_t size() noexcept { return bit_count_v; }
  [[nodiscard]] constexpr size_t max_size() noexcept { return bit_count_v; }
