...
mutable one, and nothing when it takes no lvalue (`this C&&`). An
explicit-object non-template (`void growl(this const C& self) noexcept`)
declares the same way. Static members, constructors, operators, data
