...
#include "pch.h"
#include <LibCorvid/includes/SequentialEnum.h>
...
template<>
constexpr auto corvid::seq_max_v<e0_3> = e0_3(3);

template<>
constexpr bool corvid::seq_wrap_v<e0_3> = true;

// Range of 10 to 13. Tests non-zero minimums.
enum class e10_13 : int8_t {};

template<>
constexpr auto corvid::seq_max_v<e10_13> = e10_13(13);

template<>
constexpr auto corvid::seq_min_v<e10_13> = e10_13(10);

template<>
constexpr bool corvid::seq_wrap_v<e10_13> = true;

// Range of -3 to 3. Tests negative minimums.
enum class eneg3_3 : int8_t {};

template<>
constexpr auto corvid::seq_max_v<eneg3_3> = eneg3_3(3);

template<>
constexpr auto corvid::seq_min_v<eneg3_3> = eneg3_3(-3);

template<>
constexpr bool corvid::seq_wrap_v<eneg3_3> = true;

// Range of 0 to 255. Tests exact fit, unsigned.
enum class e0_255 : uint8_t {};

template<>
constexpr auto corvid::seq_max_v<e0_255> = e0_255(255);

// Changing this has no effect.
template<>
constexpr bool corvid::seq_wrap_v<e0_255> = false;

// Range of -128 to 127. Tests exact fit, signed.
enum class eneg128_127 : int8_t {};

template<>
constexpr auto corvid::seq_max_v<eneg128_127> = eneg128_127(127);

template<>
constexpr auto corvid::seq_min_v<eneg128_127> = eneg128_127(-128);
...
template<>
constexpr auto corvid::seq_max_v<e0_3unsafe> = e0_3unsafe(3);

template<>
constexpr bool corvid::seq_wrap_v<e0_3unsafe> = false;
