...
void MetaTest_EnumBitWidth() {
  EXPECT_EQ(std::bit_width(0ull), 0u);
  EXPECT_EQ(std::bit_width(1ull), 1u);
  EXPECT_EQ(std::bit_width(2ull), 2u);
  EXPECT_EQ(std::bit_width(3ull), 2u);
  EXPECT_EQ(std::bit_width(4ull), 3u);
  EXPECT_EQ(std::bit_width(7ull), 3u);
  EXPECT_EQ(std::bit_width(8ull), 4u);
  EXPECT_EQ(std::bit_width(15ull), 4u);
  EXPECT_EQ(std::bit_width(16ull), 5u);
  EXPECT_EQ(std::bit_width(31ull), 5u);
  EXPECT_EQ(std::bit_width(32ull), 6u);
  EXPECT_EQ(std::bit_width(63ull), 6u);
  EXPECT_EQ(std::bit_width(64ull), 7u);
  EXPECT_EQ(std::bit_width(127ull), 7u);
  EXPECT_EQ(std::bit_width(128ull), 8u);
  EXPECT_EQ(std::bit_width(255ull), 8u);
  EXPECT_EQ(std::bit_width(256ull), 9u);
  EXPECT_EQ(std::bit_width(511ull), 9u);
  EXPECT_EQ(std::bit_width(512ull), 10u);
  EXPECT_EQ(std::bit_width(1023ull), 10u);
  EXPECT_EQ(std::bit_width(1024ull), 11u);
  EXPECT_EQ(std::bit_width(2047ull), 11u);
  EXPECT_EQ(std::bit_width(2048ull), 12u);
  EXPECT_EQ(std::bit_width(4095ull), 12u);
  EXPECT_EQ(std::bit_width(4096ull), 13u);
  EXPECT_EQ(std::bit_width(8191ull), 13u);
  EXPECT_EQ(std::bit_width(8192ull), 14u);
  EXPECT_EQ(std::bit_width(16383ull), 14u);
  EXPECT_EQ(std::bit_width(16384ull), 15u);
  EXPECT_EQ(std::bit_width(32767ull), 15u);
  EXPECT_EQ(std::bit_width(32768ull), 16u);
  EXPECT_EQ(std::bit_width(65535ull), 16u);
  EXPECT_EQ(std::bit_width(65536ull), 17u);
  EXPECT_EQ(std::bit_width(131071ull), 17u);
  EXPECT_EQ(std::bit_width(131072ull), 18u);
  EXPECT_EQ(std::bit_width(262143ull), 18u);
  EXPECT_EQ(std::bit_width(262144ull), 19u);
  EXPECT_EQ(std::bit_width(524287ull), 19u);
  EXPECT_EQ(std::bit_width(524288ull), 20u);
  EXPECT_EQ(std::bit_width(1048575ull), 20u);
  EXPECT_EQ(std::bit_width(1048576ull), 21u);
  EXPECT_EQ(std::bit_width(2097151ull), 21u);
  EXPECT_EQ(std::bit_width(2097152ull), 22u);
  EXPECT_EQ(std::bit_width(4194303ull), 22u);
  EXPECT_EQ(std::bit_width(4194304ull), 23u);
  EXPECT_EQ(std::bit_width(8388607ull), 23u);
  EXPECT_EQ(std::bit_width(8388608ull), 24u);
  EXPECT_EQ(std::bit_width(16777215ull), 24u);
  EXPECT_EQ(std::bit_width(16777216ull), 25u);
  EXPECT_EQ(std::bit_width(33554431ull), 25u);
  EXPECT_EQ(std::bit_width(33554432ull), 26u);
  EXPECT_EQ(std::bit_width(67108863ull), 26u);
  EXPECT_EQ(std::bit_width(67108864ull), 27u);
  EXPECT_EQ(std::bit_width(134217727ull), 27u);
  EXPECT_EQ(std::bit_width(134217728ull), 28u);
  EXPECT_EQ(std::bit_width(268435455ull), 28u);
  EXPECT_EQ(std::bit_width(268435456ull), 29u);
  EXPECT_EQ(std::bit_width(536870911ull), 29u);
  EXPECT_EQ(std::bit_width(536870912ull), 30u);
  EXPECT_EQ(std::bit_width(1073741823ull), 30u);
  EXPECT_EQ(std::bit_width(1073741824ull), 31u);
  EXPECT_EQ(std::bit_width(2147483647ull), 31u);
  EXPECT_EQ(std::bit_width(2147483648ull), 32u);
  EXPECT_EQ(std::bit_width(4294967295ull), 32u);
  EXPECT_EQ(std::bit_width(4294967296ull), 33u);
  EXPECT_EQ(std::bit_width(8589934591ull), 33u);
  EXPECT_EQ(std::bit_width(8589934592ull), 34u);
  EXPECT_EQ(std::bit_width(17179869183ull), 34u);
  EXPECT_EQ(std::bit_width(17179869184ull), 35u);
  EXPECT_EQ(std::bit_width(34359738367ull), 35u);
  EXPECT_EQ(std::bit_width(34359738368ull), 36u);
  EXPECT_EQ(std::bit_width(68719476735ull), 36u);
  EXPECT_EQ(std::bit_width(68719476736ull), 37u);
  EXPECT_EQ(std::bit_width(137438953471ull), 37u);
  EXPECT_EQ(std::bit_width(137438953472ull), 38u);
  EXPECT_EQ(std::bit_width(274877906943ull), 38u);
  EXPECT_EQ(std::bit_width(274877906944ull), 39u);
  EXPECT_EQ(std::bit_width(549755813887ull), 39u);
  EXPECT_EQ(std::bit_width(549755813888ull), 40u);
  EXPECT_EQ(std::bit_width(1099511627775ull), 40u);
  EXPECT_EQ(std::bit_width(1099511627776ull), 41u);
  EXPECT_EQ(std::bit_width(2199023255551ull), 41u);
  EXPECT_EQ(std::bit_width(2199023255552ull), 42u);
  EXPECT_EQ(std::bit_width(4398046511103ull), 42u);
  EXPECT_EQ(std::bit_width(4398046511104ull), 43u);
  EXPECT_EQ(std::bit_width(8796093022207ull), 43u);
  EXPECT_EQ(std::bit_width(8796093022208ull), 44u);
  EXPECT_EQ(std::bit_width(17592186044415ull), 44u);
  EXPECT_EQ(std::bit_width(17592186044416ull), 45u);
  EXPECT_EQ(std::bit_width(35184372088831ull), 45u);
  EXPECT_EQ(std::bit_width(35184372088832ull), 46u);
  EXPECT_EQ(std::bit_width(70368744177663ull), 46u);
  EXPECT_EQ(std::bit_width(70368744177664ull), 47u);
  EXPECT_EQ(std::bit_width(140737488355327ull), 47u);
  EXPECT_EQ(std::bit_width(140737488355328ull), 48u);
  EXPECT_EQ(std::bit_width(281474976710655ull), 48u);
  EXPECT_EQ(std::bit_width(281474976710656ull), 49u);
  EXPECT_EQ(std::bit_width(562949953421311ull), 49u);
  EXPECT_EQ(std::bit_width(562949953421312ull), 50u);
  EXPECT_EQ(std::bit_width(1125899906842623ull), 50u);
  EXPECT_EQ(std::bit_width(1125899906842624ull), 51u);
  EXPECT_EQ(std::bit_width(2251799813685247ull), 51u);
  EXPECT_EQ(std::bit_width(2251799813685248ull), 52u);
  EXPECT_EQ(std::bit_width(4503599627370495ull), 52u);
  EXPECT_EQ(std::bit_width(4503599627370496ull), 53u);
  EXPECT_EQ(std::bit_width(9007199254740991ull), 53u);
  EXPECT_EQ(std::bit_width(9007199254740992ull), 54u);
  EXPECT_EQ(std::bit_width(18014398509481983ull), 54u);
  EXPECT_EQ(std::bit_width(18014398509481984ull), 55u);
  EXPECT_EQ(std::bit_width(36028797018963967ull), 55u);
  EXPECT_EQ(std::bit_width(36028797018963968ull), 56u);
  EXPECT_EQ(std::bit_width(72057594037927935ull), 56u);
  EXPECT_EQ(std::bit_width(72057594037927936ull), 57u);
  EXPECT_EQ(std::bit_width(144115188075855871ull), 57u);
  EXPECT_EQ(std::bit_width(144115188075855872ull), 58u);
  EXPECT_EQ(std::bit_width(288230376151711743ull), 58u);
  EXPECT_EQ(std::bit_width(288230376151711744ull), 59u);
  EXPECT_EQ(std::bit_width(576460752303423487ull), 59u);
  EXPECT_EQ(std::bit_width(576460752303423488ull), 60u);
  EXPECT_EQ(std::bit_width(1152921504606846975ull), 60u);
  EXPECT_EQ(std::bit_width(1152921504606846976ull), 61u);
  EXPECT_EQ(std::bit_width(2305843009213693951ull), 61u);
  EXPECT_EQ(std::bit_width(2305843009213693952ull), 62u);
  EXPECT_EQ(std::bit_width(4611686018427387903ull), 62u);
  EXPECT_EQ(std::bit_width(4611686018427387904ull), 63u);
  EXPECT_EQ(std::bit_width(9223372036854775807ull), 63u);
  EXPECT_EQ(std::bit_width(9223372036854775808ull), 64u);
  EXPECT_EQ(std::bit_width(18446744073709551615ull), 64u);
}
