...
// in tests/CMakeLists.txt text-scans this source file for the literal `imgui`
// to decide whether to fetch, link, and -isystem the library. Keep this
// comment, or the build fails with "imgui.h file not found".
