...
void StreamConn_Lifecycle() {
  ...
  {
    stream_conn_ptr conn{loop, std::move(a), remote, {}};
...
void StreamConn_Receive() {
  ...
  std::string received;
  stream_conn_ptr conn{loop, std::move(a), {},
...
void StreamConn_HttpConnectGoogle() {
  // Skip if DNS is unavailable (no network access).
